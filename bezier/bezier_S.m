function gamma = bezier_S(data, sampling, options)

% Run the Bézier algorithm to fit a suface to the data points. We are here
% using the section approch associated to the quotient metric C = YY',
% where the totla space is endowed with the Euclidean metric.
